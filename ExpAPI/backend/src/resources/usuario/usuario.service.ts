...
import { CreateUsuarioDto, UsuarioSemSenhaDto, UpdateUsuarioDto } from "./usuario.types";
const prisma = new PrismaClient();
import { TiposUsuarios } from "../tipoUsuario/tipoUsuario.constants";

export async function getUsuarios(tipo?: TiposUsuarios): Promise<UsuarioSemSenhaDto[]> {
  if (!tipo)
...
export const createUsuario = async ( usuario: CreateUsuarioDto): Promise<UsuarioSemSenhaDto> => {
...
export const updateUsuario = async (id: string, usuario: UpdateUsuarioDto): Promise<UsuarioSemSenhaDto> => {
...
export const buscaUsuarioPorEmail = async (email: string): Promise<UsuarioSemSenhaDto | null> => {
...
export const buscaUsuarioPorId = async (id: string): Promise<UsuarioSemSenhaDto | null> => {
  return await prisma.usuario.findUnique({
    select: {
      id: true,
      tipoUsuarioId: true,
...
export const deleteUsuario = async (id: string): Promise<UsuarioSemSenhaDto> => {
